...
def create_layout():
    ...
    return html.Div(
        [
                        ...
                        [
                            ...
                            html.Div(
                                [
                                    ...
                                    html.Button(
                                        "Сбросить нынешнее выделение", id="reset-button"
                                    ),
            ...
            html.Div(
                [
                    dcc.Graph(id="graph_x_y", style={"flex": "1", "height": "800px"}),
                    dcc.Graph(id="graph_x_z", style={"flex": "1", "height": "8s00px"}),
                ],
